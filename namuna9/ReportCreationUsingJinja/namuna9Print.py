...
namuna9_template_dir = os.path.join(template_dir ,'Regular' )
static_dir = os.path.join(base_dir, 'static')
env = Environment(loader=FileSystemLoader(namuna9_template_dir))
...
def prakar1():
    try:
        # Load template
        template = env.get_template('namuna9All.html')
...
def prakar1():
    try:
        # Load template
        template = env.get_template('namuna9Gen.html')
...
def prakar1():
    try:
        # Load template
        template = env.get_template('namuna9Pani.html')
